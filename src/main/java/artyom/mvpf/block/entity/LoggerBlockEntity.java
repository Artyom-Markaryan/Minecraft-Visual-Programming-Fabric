...
public class LoggerBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    private final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(9, ItemStack.EMPTY);

    public LoggerBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.LOGGER_BLOCK_ENTITY, pos, state);
    }
